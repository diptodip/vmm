...
for i in range(1000):
    ...
    try:
        ...
        a.write("june-20/random_3p6v_" + str(i) + ".vmm")
        write_solution("june-20/random_3p6v_bf_" + str(i) + ".vmms", x, true_cost)
        write_solution("june-20/random_3p6v_iqp_" + str(i) + ".vmms", iqp, iqp_cost)
        write_solution("june-20/random_3p6v_ilp_" + str(i) + ".vmms", ilp, ilp_cost)
        write_solution("june-20/random_3p6v_ri_" + str(i) + ".vmms", ri, ri_cost)
    except:
        pass
...
plt.savefig("june-20-fig1.png", format="png", dpi=300)
plt.clf()
...
figure2 = plt.plot()
plt.savefig("june-20-fig2.png", format="png", dpi=300)
